...
import { salesData as data } from "../_data/sales";
...
function DashboardPage() {
  ...
  return (
    <div id="dashboard-page" className="pb-[200px] max-w-7xl mx-auto">
      ...
      <div className="overflow-x-auto mt-10 border border-solved-color rounded-box">
      ...
      <div className="chart-wrapper mt-6">
        <Chart ref={chartRef} options={chartOptions} data={data} type="line" />
      </div>
    </div>
  );
}
