...
import ThemeControllerDropdown from "./_components/theme-controller-dropdown";
import { Modal, useModal } from "@faceless-ui/modal";
import ModalExample from "./_components/modals/modal-example";
    ...
    <main className="min-h-screen w-full p-4">
      <header className="my-10 flex justify-between items-center">
        <div className="text-3xl font-extrabold flex items-center gap-4">
          Next JS App{" "}
          <a href="https://daisyui.com/docs/install/" className="text-info hover:underline" target="_blank">
            Daisy UI
          </a>
      ...
      <div className="wrapper flex flex-col gap-8">
        ...
        <div className="modals-wrapper">
          <div className="mb-4">
            <h5>
              Modals with{" "}
              <a href="https://www.npmjs.com/package/@faceless-ui/modal" className="text-info hover:underline" target="_blank">
                @faceless-ui/modal
              </a>
            </h5>
          </div>
          ...
          <div className="modals flex flex-wrap gap-4 items-center">
            <ModalExample />
            <button className="btn btn-xs" onClick={() => toggleModal("modal-example")}>
              Simple modal
            </button>
          </div>
        </div>
        ...
        <div className="notifications-wrapper">
          <div className="mb-4">
            <h5>
              Notifications with{" "}
              <a href="https://www.npmjs.com/package/sonner" className="text-info hover:underline" target="_blank">
                sonner
              </a>{" "}
              library
            </h5>
          ...
          <div className="notifications flex flex-wrap gap-4 items-center">
            <button className="btn btn-xs" onClick={() => toast("Hello world!")}>
              Default notification
            </button>

            <button className="btn btn-xs" onClick={() => toast.info("This is an info toast")}>
              Info toast
            </button>

            <button className="btn btn-xs" onClick={() => toast.success("This is a success toast")}>
              Success toast
            </button>

            <button className="btn btn-xs" onClick={() => toast.warning("This is a warning toast")}>
              Warning toast
            </button>

            <button className="btn btn-xs" onClick={() => toast.error("This is an error toast")}>
              Error toast
            </button>
          </div>
        </div>
